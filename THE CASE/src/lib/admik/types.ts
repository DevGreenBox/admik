...
/**
 * Строка списка опубликованных страниц (GET /pages) — без секций. Используется
 * для АВТО-навигации витрины: каждая опубликованная страница «Контента» сама
 * становится кликабельной ссылкой в шапке/футере, без ручной настройки меню.
 */
