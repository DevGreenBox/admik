...
export const MOCK_CITIES: readonly CdekCity[] = [
  { code: MOCK_CITY_MOSCOW, name: 'Москва', region: 'Москва', country: 'Россия' },
  { code: MOCK_CITY_SPB, name: 'Санкт-Петербург', region: 'Санкт-Петербург', country: 'Россия' },
  { code: 270, name: 'Новосибирск', region: 'Новосибирская область', country: 'Россия' },
  { code: 344, name: 'Екатеринбург', region: 'Свердловская область', country: 'Россия' },
  { code: 430, name: 'Казань', region: 'Республика Татарстан', country: 'Россия' },
  { code: 414, name: 'Нижний Новгород', region: 'Нижегородская область', country: 'Россия' },
  { code: 268, name: 'Челябинск', region: 'Челябинская область', country: 'Россия' },
  { code: 50, name: 'Омск', region: 'Омская область', country: 'Россия' },
  { code: 426, name: 'Самара', region: 'Самарская область', country: 'Россия' },
  { code: 438, name: 'Ростов-на-Дону', region: 'Ростовская область', country: 'Россия' },
  { code: 312, name: 'Уфа', region: 'Республика Башкортостан', country: 'Россия' },
  { code: 282, name: 'Красноярск', region: 'Красноярский край', country: 'Россия' },
  { code: 432, name: 'Пермь', region: 'Пермский край', country: 'Россия' },
  { code: 400, name: 'Воронеж', region: 'Воронежская область', country: 'Россия' },
  { code: 479, name: 'Волгоград', region: 'Волгоградская область', country: 'Россия' },
  { code: 435, name: 'Краснодар', region: 'Краснодарский край', country: 'Россия' },
  { code: 372, name: 'Саратов', region: 'Саратовская область', country: 'Россия' },
  { code: 56, name: 'Тюмень', region: 'Тюменская область', country: 'Россия' },
  { code: 277, name: 'Ижевск', region: 'Удмуртская Республика', country: 'Россия' },
  { code: 297, name: 'Барнаул', region: 'Алтайский край', country: 'Россия' },
  { code: 142, name: 'Ульяновск', region: 'Ульяновская область', country: 'Россия' },
  { code: 65, name: 'Иркутск', region: 'Иркутская область', country: 'Россия' },
  { code: 290, name: 'Хабаровск', region: 'Хабаровский край', country: 'Россия' },
  { code: 75, name: 'Владивосток', region: 'Приморский край', country: 'Россия' },
  { code: 197, name: 'Ярославль', region: 'Ярославская область', country: 'Россия' },
  { code: 78, name: 'Томск', region: 'Томская область', country: 'Россия' },
  { code: 88, name: 'Оренбург', region: 'Оренбургская область', country: 'Россия' },
  { code: 1006, name: 'Кемерово', region: 'Кемеровская область', country: 'Россия' },
  { code: 39, name: 'Рязань', region: 'Рязанская область', country: 'Россия' },
  { code: 161, name: 'Тула', region: 'Тульская область', country: 'Россия' },
  { code: 158, name: 'Липецк', region: 'Липецкая область', country: 'Россия' },
  { code: 273, name: 'Калининград', region: 'Калининградская область', country: 'Россия' },
  { code: 198, name: 'Сочи', region: 'Краснодарский край', country: 'Россия' },
  // СНГ/зарубеж (для тарификации: по РФ бесплатно, СНГ/зарубеж — платно).
  { code: 9070, name: 'Алматы', region: '', country: 'Казахстан' },
  { code: 10306, name: 'Минск', region: '', country: 'Беларусь' },
] as const;
