...
>
> **Статус:** ДИЗАЙН (ключи будут завтра). Прикладной код модуля по этому документу НЕ написан —
> только спецификация. Реализация — mock-first, боевой контур включается конфигом после получения
> терминала.
>
