...
- **Storefront API**: расчёт + ПВЗ для витрин (THE CASE, Gang Auto).
...
но крупнее под автотовары Gang Auto).
...
Виджет ПВЗ (карта) живёт на **витрине** (THE CASE / Gang Auto); бэкенд Admik отдаёт только данные
